...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| VD-001 | 2026-08-30 | none currently active | No active validation debt recorded for leads-microservice onboarding | repo-wide | project owner | no | maintain clean adoption evidence | `docs/12_validation/VAL-TASK-001-bootstrap-service.md` |
