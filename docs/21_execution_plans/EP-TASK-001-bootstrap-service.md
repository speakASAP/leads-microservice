# Execution Plan: Leads Microservice IPS adoption bootstrap
...
- No resolution of the open Orders replay/backfill blocker

## project invariants

This plan preserves LEADS-INV-001..005 by documenting them, not altering them.

## sensitive-data handling

No secrets or lead PII are read, generated, or committed; only architectural facts drawn from README/BUSINESS/SYSTEM/AGENTS/TASKS/STATE and non-secret .env.example variable names are used.
...
This plan documents, but does not resolve, the open replay/backfill validation blocker for Orders order-created events.
...
- docs/orchestrator/* (owned by the active goal-driven workstream)
...
- None identified during this bootstrap; the pre-existing Orders replay/backfill validation gap remains an open project blocker.
