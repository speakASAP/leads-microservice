# Copilot Instructions — `leads-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/leads-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/leads-microservice.git`, branch `main`.
