...
- Consult docs/orchestrator/GOALS.md, PLAN.md, and STATUS.md for the current goal-driven cadence before choosing next work
- The replay/backfill validation source for missed Orders order-created events remains an open blocker (STATE.json, TASKS.md Backlog) and must be resolved before broad live Orders event consumption
