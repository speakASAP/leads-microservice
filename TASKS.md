...
## Backlog
<!-- Human-managed -->
- Resolve Goal 29 production enablement blockers before live Orders event consumption: `[MISSING: production LEADS_ORDERS_EVENTS_RABBITMQ_URL/Vault/K8s wiring and broker smoke approval]`, and `[MISSING: replay/backfill validation source for missed Orders events]`.
...
- 2026-07-01 goal-29b-orders-created-event-runtime-handler-complete-live-broker-blocked
- 2026-07-01 goal-29-orders-event-consumer-contract-guard-tests-complete-handler-ready-live-broker-blocked
