...
## Backlog
<!-- Human-managed -->
- Resolve Goal 29 replay/backfill validation before broad live Orders event consumption: `[MISSING: replay/backfill validation source for missed Orders events]`.
